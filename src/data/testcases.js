const testCases = [
    ...
    { id: 'TC-010', name: 'Brute Force Prevention', status: 'Passed', automationStatus: 'Automated', lastExecuted: '2025-03-12', version: 'v2.2' },
    { id: 'TC-011', name: 'SMS 2FA Verification', status: 'Failed', automationStatus: 'Automated', lastExecuted: '2025-03-10', version: 'v2.2' },
    { id: 'TC-012', name: 'Email 2FA Verification', status: 'Passed', automationStatus: 'Automated', lastExecuted: '2025-03-10', version: 'v2.2' },
